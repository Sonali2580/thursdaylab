//4.Write a code to implement covid vaccination booster doze system. For male if the age is more than 60 and for female if 
//the age is more than fifty and nationality must be Indian then eligible for doze.
//Else throw custom exception with proper message.
...
public class CovidBooster2212 {
	...
	public static void main(String[] args) {
		...
		try
		{
			CovidBooster2212.eligibility(gender,age,nationality);
	    }  
